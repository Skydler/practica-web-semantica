...
from db.repository import OwlMovieRepository, JsonMovieRepository
...
from scrapers import cinemalaplata, cinepolis, jsonld
...
CINEPOLIS_MOVIES = SCRAP_ROOT / "cinepolis.json"
CINEMA_MOVIES = SCRAP_ROOT / "cinemalaplata.json"

MERGE_FILE = DATA_ROOT / "movie_individuals.ttl"
